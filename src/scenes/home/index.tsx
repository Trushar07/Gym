        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-sm ">
              ...
              laborum, quaerat atque odit minus itaque, commodi molestias
              perspiciatis obcaecati facere fuga saepe aliquid cupiditate, nulla
              consequatur. Iusto, possimus dolore! Veritatis.
            </p>
          </motion.div>
          {/* Actions */}
          <motion.div
